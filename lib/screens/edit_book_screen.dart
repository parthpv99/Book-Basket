...
class _EditBookState extends State<EditBook> {
  ...
  void imageToBase64(File image, int i) {
    if (i == 0) {
      path1 = base64Encode(image.readAsBytesSync());
      pathname1 = '1.jpg';
    } else if (i == 1) {
      path2 = base64Encode(image.readAsBytesSync());
      pathname2 = '2.jpg';
    } else if (i == 2) {
      path3 = base64Encode(image.readAsBytesSync());
      pathname3 = '3.jpg';
    } else if (i == 3) {
      path4 = base64Encode(image.readAsBytesSync());
      pathname4 = '4.jpg';
    }
  }
